...
#
""" Ionix module for getting info
    about any user on Telegram but master you are not an exception . """

from telethon.events import NewMessage
from typing import Union

from ionix import CMD_HELP
...
@ionix.on(admin_cmd(pattern=r"u(?:ser)?(\s+[\S\s]+|$)", outgoing=True))
