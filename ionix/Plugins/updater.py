...
OFFICIAL_UPSTREAM_REPO = "https://github.com/Ion-cell/Ionix"
BOT_IS_UP_TO_DATE = "Ionix is fully loaded wanna test!"
NEW_BOT_UP_DATE_FOUND = (
    "**Ionix Update Found For** {branch_name}\n"
    "\n\n{changelog}\n"
    "Pulling Updates !!"
)
NEW_UP_DATE_FOUND = (
...
async def updater(message):
    ...
    if not changelog:
        await message.edit("**Updating ur ak47 Ionix** \n**Version** : `2.0` \n**Telethon** : `1.15.0` \n**Status** : `Pulling Updates` \n**Thank You master For Using me- Ionix !**")
...
async def deploy_start(bot, message, refspec, remote):
    ...
    await message.edit("**Updating Ionix** \n**Version** : `2.0` \n**Telethon** : `1.15.0` \n**Branch** : `Master` \n**Status** : `Updating reloading & Restarting` \n__You Can Do__ `.alive` __To Check If I am still working or dead !__")
...
async def updater(message):
    ...
    if not changelog:
        await borg.send_message("**updating Ionix** \n**Version** : `2.0` \n**Telethon** : `1.15.0` \n**Status** : `Pulling Updates` \n**HEYYA! i'm grateful that you are using me- Ionix thanks a lot master(｡♡‿♡｡) !**")
        await asyncio.sleep(5)
